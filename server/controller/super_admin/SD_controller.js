const classSchema = require('../../model/SD_model/classSchema')
...
const timetableSchema = require('../../model/SD_model/timeTableSchema')
...
module.exports.addStudent = async (req, res) =>{
    try{
        ...
        student.studentNo = req.body.studentNo
...
module.exports.GradeTitles = async (req, res) => {
    try{
        
        await gradeSchema.find({section: req.params.title})
            .then((data) => {
...
module.exports.GradeTitlesByClass = async (req, res) => {
    try{
        
        await gradeSchema.find({stdclass: req.params.title})
            .then((data) => {
                return res.json(data)
            })
            .catch((err) => {
...
module.exports.addStudentGrade = async (req, res) => {
    try{
        ...
        grade.section = req.body.section
        grade.stdclass = req.body.stdcLass
...
module.exports.classGrades = async (req, res) => {
    try{
        await gradeSchema.find({ stdclass: req.params.title_1, title: req.params.title_2 })
            .then((data) => {
                return res.json(data)
            })
            .catch((err) => {
...
module.exports.classGradesBySection = async (req, res) => {
    try{
        await gradeSchema.find({ stdclass: req.params.title_1, title: req.params.title_2, section: req.params.title_3 })
            .then((data) => {
                return res.json(data)
            })
            .catch((err) => {
...
module.exports.deleteClass = async (req, res) => {
    try{
        const currClass = await classSchema.findOne({_id: req.params.id});
        await classSchema.findByIdAndDelete(req.params.id)
            .then(() => {
                return res.json({
                    message: "section delete successful",
                    success: "success",
        ...
        await sectionSchema.deleteMany({classTitle: currClass.title})
        
        
        await studentSchema.deleteMany({Class: currClass.title})
...
module.exports.updateClass = async (req, res) => {
    ...
    try{
        ...
        const currClass = await classSchema.findById(req.params.id)
        
            if(currClass){
                await sectionSchema.updateMany(
                    { classTitle: currClass.title },
                    { $set: { classTitle: req.body.title } }
                )
                    

                await studentSchema.updateMany(
                    { Class: currClass.title },
                    { $set: { Class: req.body.title } }
                )

                currClass.title = req.body.title
                currClass.incharge = req.body.incharge
                currClass.description = req.body.description
