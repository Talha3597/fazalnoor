 ...
 <>
  ...
  {gdata.map(item => {  
                        return <tr key={item._id}> 
                            ...
                            <td> 
                            {role=='superAdmin'? 
                            <Link to={`/updateExpense/${item._id}` }><Button className='btn btn-outline-info bg-light '   >
                            Edit</Button></Link>:''}</td>
                            <td>    {role=='superAdmin'?
                            <Button className='btn btn-outline-danger bg-light ' onClick={() => removeData(item._id)}>
                             Delete
                            </Button>:''}</td>
                            <td>   <Link to={`/expenseView/${item._id}` }><Button className='btn btn-outline-warning bg-light '   >
                            View</Button></Link></td>
                        </tr>  
                    })}  
