...
function SectionAttendance(){
    ...
    const studentList = () => {
        ...
        <tbody>
            <tr>
                <td>{currentstudent.studentNo}</td>
                ...
                <td>
                    <Form.Group controlId="formBasicCheckbox">
                        ...
                        onChange={e => {
                            ...
                            const dataObj = {
                                admin_no: currentstudent.studentNo,
                                name: currentstudent.studentName
                            }

                            if(checked === true){
                                presentStudents.push(dataObj)
                                setAbsentStudents(absentStudents.filter(el => el.admin_no !== currentstudent.studentNo))
                            ...
                            if(checked === false || checked === '' || checked === undefined || checked === null){
                                ...
                                setPresentStudents(presentStudents.filter(el => el.admin_no !== currentstudent.studentNo))
