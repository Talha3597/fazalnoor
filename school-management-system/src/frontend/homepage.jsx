...
<div className='row'>
  <div className='side'>
    <h2>Principal's Messge</h2>
    
    <div className='fakeimg' style={{height:200}} ><h4>In life, no one and nothing will help you until you start helping yourself. 
    </h4></div>
    ...
    <div className='fakeimg2'><FaIcons.FaFootballBall style={{fontSize:100}}/><h5>Sports</h5></div>
  </div>
  <div className='main'>
    <h2>Our Mission</h2>
   
    <div className='fakeimg' style={{height:200}}><h5>Our mission is to develop well rounded, confident and responsible individuals who aspire to achieve their full potential. We will do this by providing a welcoming, happy, safe, and supportive learning environment in which everyone is equal and all achievements are celebrated.</h5></div> <h3>A Quality School..</h3>
    <strong>Faculty prepare high-quality teachers and school leaders to teach and lead across curricula, age spans and diverse learning environments.</strong>
    <br/>
    ...
    <Image style={{height:350}}src='/images/board.jpeg' alt='Fazal Noor School'  />
    </div>
     </div>
</div>
<div className='empty'/>
<div className='footer' style={{color:'whitesmoke'}}>
<Row>
  <Col md={8}>
